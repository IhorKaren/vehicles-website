...
export const StickyPrice: React.FC<TopTitleProps> = ({ vehicle }) => {
  const formattedDate = format(new Date(vehicle.createdAt), "M/d/yy");
  ...
  return (
    <StickyContainer elevation={3}>
      ...
      <Typography variant="body2">{convertToMoney(vehicle.price)}</Typography>
      <Typography
        variant="body2"
