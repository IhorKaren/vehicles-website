...
export const SearchForm = () => {
  ...
  const handleStockOnlyChange = (event) => setStockOnly(event.target.checked);
  return (
    <SearchFormBox>
      {/* Selection for Make */}
      ...
      <FormControl fullWidth margin="normal">
        ...
        <Select value={mileage} onChange={handleMileageChange} label="Mileage">
          {/* Replace with actual options */}
      ...
      <FormControlLabel
        control={
          <Checkbox checked={stockOnly} onChange={handleStockOnlyChange} />
        }
